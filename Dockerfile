...
RUN sed -i 's|return NextResponse.redirect(signInUrl);|return NextResponse.redirect(process.env.NEXTAUTH_URL + ":80/api/auth/signin?callbackUrl=%2");|g' .next/server/src/middleware.js
